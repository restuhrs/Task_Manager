...
export default function FooterNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 w-full bg-white border-t shadow-md flex justify-around py-2 z-50">
      {navItems.map((item) => {
        ...
        return (
          ...
          >
            ...
            {/* underline effect */}
            {isActive && (
              <span className="absolute bottom-0 left-1/4 w-1/2 h-1 bg-blue-500 rounded-full" />
            )}
          </Link>
        );
      })}
